...
<?php 
    if(isset($_POST['submit'])){
        ...
        $sql = "UPDATE buku SET id_buku='$id_buku', Kode_buku='$Kode_buku', Judul_buku='$Judul_buku', penulis_buku='$penulis_buku', tahun_terbit='$tahun_terbit', stok='$stok', no_rak='$no_rak', nama_rak='$nama_rak', lokasi_rak='$lokasi_rak' WHERE id_buku='$id_buku'";
