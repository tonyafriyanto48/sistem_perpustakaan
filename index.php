...
<nav class="navbar navbar-dark bg-info">  
        <a class="navbar-brand" href="#">
            <img src="image/logo_smk_bina_am_ma_mur_tangerang_1.png" width="30" height="30" class="d-inline-block align-top" alt="">
        ...
        <ul class="nav nav-tabs ">
            ...
            <li class="nav-item">
              ...
              <div class="offcanvas-body">
                <div>
                  Tidak Disarankan Bagi siswa untuk Login ! <p></p><p>Apa Anda Benar Ingin Login ? </p>
                </div>
...
<main class="flex-shrink-0">
  <div class="container">
    <h1 class="mt-2 text-white ">Selamat Datang Di sistem <p>Perpustakaan SMK Bina AM Ma'mur</p></h1>
    <p class="lead text-white ">Website Ini membantu siswa dalam Mencari Buku yang Tersedia di perpustakaan ini</p>
    <p class="text-white">Baca <a href="halaman_index/peraturan.php" class="docs-creator">Peraturan Perpustakaan</a> Untuk lebih Lanjut.</p>
  </div>
</main>
</div>
<!--tabel-->
